...
| [SDLOG_PROFILE](../advanced_config/parameter_reference.md#SDLOG_PROFILE) | Logging profile. Use this to enable less common logging/analysis (e.g. for EKF2 replay, high rate logging for PID & filter tuning, thermal temperature calibration, or flapping-wing dataset collection).                                                                                                                                         |
...
- Flapping dataset collection: [SDLOG_PROFILE=4097](../advanced_config/parameter_reference.md#SDLOG_PROFILE) for default logging plus the flapping dataset profile.
- Flapping dataset collection with EKF replay: [SDLOG_PROFILE=4099](../advanced_config/parameter_reference.md#SDLOG_PROFILE).
